...
| ``PC-R-1``| enp0s3 |    192.168.100.0/24 |
| ``PC-R-1``| enp0s8 |    192.168.200.97/29  |
| ``PC-R-2``| enp0s3 |    192.268.0.1/24   |
| ``PC-R-2``| enp0s8  |    192.168.200.98/29   |
| ``PC-R-2``| enp0s9  |     |
| ``PC-R-2``| enp0s10 |      |
| ``PC2``   | enp0s3  |   192.168.0.101  |
...
| --------- |:-------------| :---------------| 
| ``PC1``     |  | |
| ``default`` |  | enp0s3 ``ip route add default via 192.168.100.1/24`` |
| ``PC-R-1``  |  |        |
| ```` |  | enp0s3 |
| ```` |  | enp0s8 |
| mozna dzielic   |  |  |
...
| ``PC-R-2``  |  |        |
| ```` |  | enp0s3 |
| ```` |  | enp0s3 ``ip route add default via 192.168.0.1/24`` |
| ````  |   | enp0s8 |
| ```` |  | enp0s9 |
| ```` |  | enp0s10 |
